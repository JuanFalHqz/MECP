...
urlpatterns = [
    ...
    path('admin-add-question1', views.admin_add_question1_view, name='admin-add-question1'),
    path('admin-add-question2', views.admin_add_question2_view, name='admin-add-question2'),
    ...
    path('update-question1/<int:pk>', views.update_question1_view, name='update-question1'),
    path('update-question2/<int:pk>', views.update_question2_view, name='update-question2'),
    path('view-question/<int:pk>', views.view_question_view, name='view-question'),
    path('delete-question/<int:pk>', views.delete_question_view, name='delete-question'),
    path('delete-question1/<int:pk>', views.delete_question1_view, name='delete-question1'),
    path('delete-question2/<int:pk>', views.delete_question2_view, name='delete-question2'),
