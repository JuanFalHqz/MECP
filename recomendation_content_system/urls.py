...
app_name = 'recomendation_content_system'
...
urlpatterns = [
    ...
    path('detail_contenido_to_student/<int:contenido_id>/', views.detail_contenido_to_student_view,name='detail_contenido_to_student'),
    ...
    path('list_contenidos/', views.list_contenidos.as_view(), name='list_contenidos'),
]
