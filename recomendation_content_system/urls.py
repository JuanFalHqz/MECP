...
from . import views
from recomendation_content_system.views import DetailProfessionalContent
...
urlpatterns = [
    ...
    path('recommender_contentl/<int:pk>/', DetailProfessionalContent.as_view(), name='detail_contenido_to_student'),
